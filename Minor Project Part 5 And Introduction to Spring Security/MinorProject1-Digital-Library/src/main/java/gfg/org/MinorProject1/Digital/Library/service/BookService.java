...
//
//        String bookKey = BOOK_KEY + ":list" + savedBook.getId();
//        redisTemplate.opsForList().leftPushAll(bookKey, savedBook);
//        redisTemplate.expire(bookKey, Duration.ofMinutes(10));
//
//
...
//        String bookKey = BOOK_KEY + ":list" + id;
//
//            List<Object> bookList  =  redisTemplate.opsForList().range(bookKey,0 ,-1);
//
//
//            if(bookList != null){
